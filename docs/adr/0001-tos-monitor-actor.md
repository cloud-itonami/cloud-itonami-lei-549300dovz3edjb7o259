...
DXC Technology Company, per ADR-2607110300 -- a read-only reference
archive. As part of a fourth 10-repo validation batch extending the
...
- **Company**: DXC Technology Company, LEI 549300DOVZ3EDJB7O259, website
  `https://dxc.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://dxc.com/legal`, retrieved-at
  `2026-07-19`, doc-type `:terms-of-service`.
