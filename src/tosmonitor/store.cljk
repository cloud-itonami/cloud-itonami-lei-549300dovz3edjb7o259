(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (DXC Technology Company, LEI
  549300DOVZ3EDJB7O259) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "DXC Technology Company"
   :website    "https://dxc.com"})

(def ^:private demo-full-text
  "DXC Site Terms\nThis site is a website owned and operated by DXC Technology Company and/or its affiliates for the purpose of providing information about our IT services offerings. By accessing this site you agree to these Terms, which are governed by the laws of the State of Nevada.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://dxc.com/legal"
